...
// normalizeRetiredThemeOption keeps the removed frontend option readable for
// older clients while ensuring the only supported dashboard is the default one.
