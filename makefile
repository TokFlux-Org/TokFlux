...
.PHONY: all build-frontend build-frontend-classic build-all-frontends start-backend dev-backend-hot dev-api dev-api-rebuild dev-web dev-web-classic dev reset-setup
